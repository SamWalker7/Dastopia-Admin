...
const AddCar = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const data = {
        ...
        make:
          formValues.otherMake !== "" ? formValues.otherMake : formValues.make,
      };
  ...
  const secondStepperFormValidation = () =>
    Object.entries(documents).some(([key, field]) =>
      key === "powerOfAttorney" ? false : field === ""
    );
    ...
    <Box sx={{ width: "100%" }}>
        ...
        <Box component="form" noValidate autoComplete="off" sx={{ mt: 2 }}>
          ...
          {firstStepperFormValidation() && (
            <Typography style={{ color: "red" }} variant="subtitle1">
              Please fill in the required fields and upload at least one picture
            </Typography>
          )}
        </Box>
      )}
      {tab === 1 && (
        <Box component="form" noValidate autoComplete="off" sx={{ mt: 2 }}>
          ...
          <Typography variant="body2">Vehicle Tag or Plate Number</Typography>
          <Grid container spacing={2} sx={{ mt: 2 }}>
