...
import UploadIcon from '@mui/icons-material/Upload'; import { getVehicleById, getDownloadUrl, updateVehicle, getPreSignedURL, getPreSignedURLAdmin, uplaodVehicleImagesToS3 } from "../api";
...
const EditVehicle = ({ match }) => {
    ...
    const secondStepperFormValidation = () => Object.entries(documents).some(([key, field]) => key !== "powerOfAttorney" && field === '');
